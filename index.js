    ...
    layout({
      ...
      bodyHtml: `
        <style>
          ...
          .paypal-dark{ color:#003087; }
          .paypal-light{ color:#009cde; }
          ...
          @media (max-width:768px){
            .cashout-page{
              padding:18px 0 320px !important;
            }
          ...
          @media (max-width:480px){
            .cashout-page{
              padding:16px 0 340px !important;
            }
